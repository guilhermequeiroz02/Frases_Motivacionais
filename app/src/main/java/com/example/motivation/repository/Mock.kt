...
class Mock {
    ...
    private val ALL = MotivationConstantes.PHRASEFILTER.ALL
    private val HAPPY = MotivationConstantes.PHRASEFILTER.HAPPY
    private val MORNING = MotivationConstantes.PHRASEFILTER.MORNING
